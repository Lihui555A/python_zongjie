...
class MainUi(QtWidgets.QMainWindow):
    ...
    def init_ui(self):
        ...
        self.left_button_8 = QtWidgets.QPushButton( qtawesome.icon('fa.question',color='white'),"关注我们")
        ...
        self.search_icon = QtWidgets.QLabel( '      搜索 ')
        ...
        self.recommend_button_1.setIcon(QtGui.QIcon('./30.jpg'))  # 设置按钮图标
        ...
        self.recommend_button_2.setIcon(QtGui.QIcon('./30.jpg'))
        #self.recommend_button_2.setStyleSheet("QToolButton{border-image: url(30.jpg)}")
        self.recommend_button_2.setIconSize(QtCore.QSize(120, 100))
        ...
        self.recommend_button_3.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.recommend_button_4.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.recommend_button_5.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.playlist_button_1.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.playlist_button_2.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.playlist_button_3.setIcon(QtGui.QIcon('./30.jpg'))
        ...
        self.playlist_button_4.setIcon(QtGui.QIcon('./30.jpg'))
